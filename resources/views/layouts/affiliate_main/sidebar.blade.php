        ...
        <div class="list-group list-group-flush mx-2 mt-4">
            ...
            <div class="list-group">
                ...
                <div class="collapse ms-3" id="reportsSubmenu">
                    <a href="{{ route('traffic_report') }}" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init>
                        Traffic Report 
                    </a>
                    <a href="{{ route('income_report') }}" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init>
                        Income Report 
                    </a>
                    <a href="{{ route('order_tracking') }}" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init>
                        Live Order Tracking
                    </a>
                    <a href="{{ route('transaction_product_report') }}" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init>
            ...
            <div class="list-group">
                ...
                <div class="collapse ms-3" id="paymentSubmenu">
                    <a href="{{ route('withdrawals') }}" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init>
                      Withdrawals
                    </a>
            ...
            <div class="list-group">
                ...
                <div class="collapse ms-3" id="accountSubmenu">
                    <a href="{{ route('mywebsites_page') }}" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init>
                      My Websites
                    </a>
                    <a href="{{ route('tracking_id') }}" class="list-group-item list-group-item-action py-2" data-mdb-ripple-init>
                        Tracking ID
                    </a>
                </div>
            </div>
