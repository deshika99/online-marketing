                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="woocommerce-widget-area">
                            <div class="woocommerce-widget filter-list-widget">
                                    ...
                                    <a href="{{ route('best-seller') }}" class="delete-selected-filters"><i class='bx bx-trash'></i> <span>Clear All</span></a>
                            ...
                            <div class="woocommerce-widget collections-list-widget">
                                ...
                                @foreach($categories as $category)
                                    <li>
                                        <a href="{{ route('best-seller') }}?category={{ $category->parent_category }}" 
                            ...
                            <div class="woocommerce-widget size-list-widget">
                                ...
                                <ul class="size-list-row">
                                    @foreach($sizes as $size)
                                        <li>
                                            <a href="{{ route('best-seller') }}?size={{ $size->value }}" 
                            ...
                            <div class="woocommerce-widget color-list-widget">
                                ...
                                <ul class="color-list-row">
                                    @foreach($colors as $color)
                                        <li>
                                            <a href="{{ route('best-seller') }}?color={{ $color->value }}" 
