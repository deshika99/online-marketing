                    ...
                    <div class="p-4">
                        ...
                        <div class="tab-content mt-4" id="paymentTabsContent">
                            ...
                            <div class="tab-pane fade" id="cash-on-delivery" role="tabpanel" aria-labelledby="cash-on-delivery-tab">
                                ...
                                <form action="{{ route('order.confirm.cod', ['order_code' => $order_code]) }}" method="POST">
                                    @csrf
                ...
                <div class="card shadow-0 border summary-card">
                    <div class="p-4">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <h6 class="mb-2 fw-bold">Rs. {{ $cart->sum(fn($item) => $item->product->normal_price * $item->quantity) + 300 }}</h6>
                        </div>
                    </div>
                </div>
            </div>
