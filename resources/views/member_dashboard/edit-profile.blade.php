    ...
    @method('PUT')
      ...
      <div class="col-md-3 text-left">
            <div class="mb-3">
                ...
                @else
                    <img src="\assets\images\default-user.png" alt="Default Profile Image" class="rounded-circle" id="profileImagePreview" width="120" height="120" style="cursor: pointer;">
                @endif
            </div>
            <input type="file" class="d-none" id="profileImageInput" name="profile_image">
        </div>
