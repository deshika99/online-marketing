            ...
            <div class="card-body">
                <div class="tab-content" id="myTabContent0">
                                    ...
                                    <div class="col-md-3">
                                        <div class="deal-items">
                                            ...
                                            <a href="#">
                                                ...
                                                <a href="<?php echo e(route('products.promoteModal', $product->id)); ?>" class="btn btn-primary  btn_promote mb-4" data-bs-toggle="modal" data-bs-target="#promoteModal">Promote Now</a>
                                            </a>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="tab-pane fade" id="commision" role="tabpanel" aria-labelledby="commision-tab0">
                        <form id="highComForm" method="GET" action="<?php echo e(route('ad_center')); ?>">
                            <div class="row">
                                <div class="col-md-2 mb-3">
...
<?php echo $__env->make('layouts.affiliate_main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\online-marketing\resources\views/affiliate_dashboard/ad_center.blade.php ENDPATH**/ ?>