            ...
            <div class="p-4">
              ...
              <?php $__empty_1 = true; $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <div class="d-flex justify-content-between">
                      <p class="mb-2"><?php echo e($item['title']); ?> x <?php echo e($item['quantity'] ?? 1); ?></p>
                      <p class="mb-2">Rs. <?php echo e(($item['price'] ?? 0) * ($item['quantity'] ?? 1)); ?></p>
                  </div>
              ...
              <div class="d-flex justify-content-between">
                ...
                <p class="mb-2">Rs.<?php echo e(array_sum(array_map(fn($item) => $item['price'] * $item['quantity'], $cart))); ?></p>
              </div>
              <div class="d-flex justify-content-between">
              ...
              <div class="d-flex justify-content-between">
                ...
                <h5 class="mb-2 fw-bold">Rs. <?php echo e(array_sum(array_map(fn($item) => $item['price'] * $item['quantity'], $cart)) + 250); ?></h5>
              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chint\OneDrive\Documents\GitHub\online-marketing\resources\views/checkout.blade.php ENDPATH**/ ?>