  ...
  <header>
    ...
    <div id="introCarousel" class="carousel slide carousel-fade shadow-2-strong" data-mdb-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active" style="background-image: url('/assets/images/slider/slider.png');">
          <div class="d-flex justify-content-center align-items-center h-100">
            <div class="text-white" data-mdb-theme="dark">
              ...
              <a class="btn btn-outline-light btn-lg m-2" data-mdb-ripple-init href="" role="button" rel="nofollow">Add to Cart</a>
            </div>
          </div>
        </div>

        <!-- Single item -->
        <div class="carousel-item" style="background-image: url('/assets/images/slider/slider1.png');">
          <div class="d-flex justify-content-center align-items-center h-100">
            <div class="text-white" data-mdb-theme="dark">
              <h1 class="mb-3">Elevate Your <br>Lifestyle</h1>
              <h5 class="mb-4">On home & living, leisure & more</h5>
        ...
        <!-- Single item -->
        <div class="carousel-item" style="background-image: url('/assets/images/slider/slider3.png');">
          <div class="d-flex justify-content-center align-items-center h-100">
            <div class="text-white" data-mdb-theme="dark">
              <h1 class="mb-3">Elevate Your <br>Lifestyle</h1>
              <h5 class="mb-4">On home & living, leisure & more</h5>
...
<?php /**PATH C:\Users\chint\OneDrive\Documents\GitHub\online-marketing\resources\views/includes/slider.blade.php ENDPATH**/ ?>