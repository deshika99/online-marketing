...
<section class="about-area ptb-100">
    <div class="container">
        ...
        <div class="facility-slides owl-carousel owl-theme my-5">
            ...
            <div class="single-facility-box">
                ...
                <h3 style="margin-top: 10px;">Easy Return Policy</h3>
            </div>
            ...
            <div class="single-facility-box">
                ...
                <h3 style="margin-top: 10px;">Weekend Discount Coupon</h3>
            </div>
            ...
            <div class="single-facility-box">
                ...
                <h3 style="margin-top: 10px;">Secure Payment Methods</h3>
            </div>
            ...
            <div class="single-facility-box">
                ...
                <h3 style="margin-top: 10px;">Track Your Package</h3>
            </div>
            ...
            <div class="single-facility-box">
                ...
                <h3 style="margin-top: 10px;">24/7 Customer Support</h3>
            </div>
        </div>
        <!-- End Facility Area -->
