						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="about-text">
                                ...
                                <ul class="features-list">
                                    <li><i class='bx bx-check'></i> People like OMC</li>
                                    <li><i class='bx bx-check'></i> World's finest OMC</li>
                                    <li><i class='bx bx-check'></i> The original OMC</li>
                                    <li><i class='bx bx-check'></i> We trust OMC</li>
                                </ul>
							</div>
						</div>
            ...
            <div class="container">
                ...
                <div class="testimonials-slides owl-carousel owl-theme">
                    <div class="single-testimonials-item">
                        ...
                        <div class="info">
                            <img src="frontend/assets/img/user1.jpg" class="shadow rounded-circle" alt="image">
                            <h3>John Smith</h3>
                            <span>Student</span>
                        </div>
                    </div>
                    ...
                    <div class="single-testimonials-item">
                        ...
                        <div class="info">
                            <img src="frontend/assets/img/user2.jpg" class="shadow rounded-circle" alt="image">
                            <h3>Sarah Taylor</h3>
                            <span>Student</span>
                        </div>
                    </div>
                    ...
                    <div class="single-testimonials-item">
                        ...
                        <div class="info">
                            <img src="frontend/assets/img/user3.jpg" class="shadow rounded-circle" alt="image">
                            <h3>David Warner</h3>
                            <span>Student</span>
                        </div>
                    </div>
                    ...
                    <div class="single-testimonials-item">
                        ...
                        <div class="info">
                            <img src="frontend/assets/img/user4.jpg" class="shadow rounded-circle" alt="image">
