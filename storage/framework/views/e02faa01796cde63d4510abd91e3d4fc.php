                        ...
                        <tbody>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($category->parent_category); ?></td>
                                    <td>
                                        <?php if($category->image): ?>
                                        <img src="<?php echo e(asset('storage/category_images/' . basename($category->image))); ?>" alt="Category Image" style="max-width: 70px;">
                                        <?php else: ?>
                                            No Image
                                        <?php endif; ?>
                                    </td>
                                        ...
                                        <ul class="subcategory-list">
                                            <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="subcategory-item">
                                                    ...
                                                    <?php if($subcategory->subSubcategories->count() > 0): ?>
                                                        <ul class="subsubcategory-list d-none">
                                                            <?php $__currentLoopData = $subcategory->subSubcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subsubcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li class="subsubcategory-item">- <?php echo e($subsubcategory->sub_subcategory); ?></li>
                                    ...
                                    <td>
                                        <div class="category-actions">
                                            <a href="<?php echo e(route('edit_category', $category->id )); ?>" class="btn btn-sm btn-warning" >
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button class="btn btn-sm btn-danger delete-category" data-id="<?php echo e($category->id); ?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-2">
            ...
            <div class="modal-body">
                <form id="categoryForm" method="POST" action="<?php echo e(route('category_add')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.admin_main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/admin_dashboard/category.blade.php ENDPATH**/ ?>