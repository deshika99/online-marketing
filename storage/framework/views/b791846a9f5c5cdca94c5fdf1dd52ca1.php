...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row submit-btn mb-0">
                            <div class="col-md-7 offset-md-4">
                                ...
                                <a href="<?php echo e(route('aff_login')); ?>" style="text-decoration:none;"><h6 class="mt-3 text-danger">Login for Affiliate</h6></a>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chint\OneDrive\Documents\GitHub\online-marketing\resources\views/aff_reg.blade.php ENDPATH**/ ?>