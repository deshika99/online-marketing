    ...
    <div class="container py-5">
        ...
        <div class="card-container px-4">
            <div class="card py-2 px-4">
                <div class="card-body">
                    <form action="<?php echo e(route('store_offers')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row mb-4">
...
<?php echo $__env->make('layouts.admin_main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/admin_dashboard/add_offers.blade.php ENDPATH**/ ?>