                ...
                <div class="col-12 mb-3">
                    ...
                    <div class="form-outline">
                        <input type="text" name="first_name" id="firstName" placeholder="" class="form-control" 
                              value="<?php echo e(old('first_name', optional($defaultAddress)->full_name ?? optional($user)->name)); ?>" required />
                ...
                <div class="col-6 mb-3">
                    ...
                    <div class="form-outline">
                        <input type="tel" name="phone" id="phone" class="form-control" 
                              value="<?php echo e(old('phone', optional($defaultAddress)->phone_num ?? optional($user)->phone_num)); ?>" required />
                ...
                <div class="col-6 mb-3">
                    ...
                    <div class="form-outline">
                        <input type="email" name="email" id="billingEmail" placeholder="" class="form-control" 
                              value="<?php echo e(old('email', optional($defaultAddress)->email ?? optional($user)->email)); ?>" required />
            ...
            <div class="col-sm-12 mb-3">
                ...
                <div class="form-outline">
                    <input type="text" name="address" id="address" placeholder="" class="form-control" 
                          value="<?php echo e(old('address', optional($defaultAddress)->address ?? '')); ?>" required />
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <div class="form-outline">
                        <input type="text" name="city" id="city" placeholder="" class="form-control" 
                              value="<?php echo e(old('city', optional($defaultAddress)->city ?? '')); ?>" required />
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <div class="form-outline">
                        <input type="text" name="postal_code" id="postalCode" class="form-control" 
                              value="<?php echo e(old('postal_code', optional($defaultAddress)->postal_code ?? '')); ?>" required />
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="mb-2">
                                    ...
                                    ?>
                                    Rs. <?php echo e(number_format($price * ($item->quantity ?? 1), 2)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\online-marketing\resources\views/checkout.blade.php ENDPATH**/ ?>