                          ...
                          <div class="col-12 mb-3">
                              ...
                              <div class="form-outline">
                                  <input type="text" name="first_name" id="firstName" placeholder="" class="form-control" 
                                        value="<?php echo e(old('first_name', $defaultAddress->full_name ?? $user->name)); ?>" required />
                          ...
                          <div class="col-6 mb-3">
                              ...
                              <div class="form-outline">
                                  <input type="tel" name="phone" id="phone" class="form-control" 
                                        value="<?php echo e(old('phone', $defaultAddress->phone_num ?? $user->phone_num)); ?>" required />
                          ...
                          <div class="col-6 mb-3">
                              ...
                              <div class="form-outline">
                                  <input type="email" name="email" id="billingEmail" placeholder="" class="form-control" 
                                        value="<?php echo e(old('email', $defaultAddress->email ?? $user->email)); ?>" required />
                          ...
                          <div class="col-sm-12 mb-3">
                              ...
                              <div class="form-outline">
                                  <input type="text" name="company_name" id="companyName" placeholder="" class="form-control" 
                                        value="<?php echo e(old('company_name', $defaultAddress->company_name ?? '')); ?>" />
                              </div>
                          </div>
                      </div>
                      <div class="col-sm-12 mb-3">
                          ...
                          <div class="form-outline">
                              <input type="text" name="address" id="address" placeholder="" class="form-control" 
                                    value="<?php echo e(old('address', $defaultAddress->address ?? '')); ?>" required />
                          ...
                          <div class="col-sm-12 mb-3">
                              ...
                              <div class="form-outline">
                                  <input type="text" name="apartment" id="apartment" placeholder="" class="form-control" 
                                        value="<?php echo e(old('apartment', $defaultAddress->apartment ?? '')); ?>" />
                              </div>
                          </div>
                          <div class="col-sm-6 mb-3">
                              ...
                              <div class="form-outline">
                                  <input type="text" name="city" id="city" placeholder="" class="form-control" 
                                        value="<?php echo e(old('city', $defaultAddress->city ?? '')); ?>" required />
                          ...
                          <div class="col-sm-6 mb-3">
                              ...
                              <div class="form-outline">
                                  <input type="text" name="postal_code" id="postalCode" class="form-control" 
                                        value="<?php echo e(old('postal_code', $defaultAddress->postal_code ?? '')); ?>" required />
