    ...
    <div class="container p-5">
        ...
        <div class="card-container px-4">
            <div class="card py-3 px-5">
                <div class="card-body">
                    <form id="productForm" action="<?php echo e(route('store_product')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin_main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/admin_dashboard/add_products.blade.php ENDPATH**/ ?>