...
<div class="dashboard-header">
    <?php if(isset($user)): ?>
        <img src="<?php echo e($user->profile_image_url); ?>" alt="Profile Picture" style="width: 80px; height: auto; border-radius: 50%; object-fit: cover; margin-right: 20px;">

        <span style="font-size: 22px; font-weight: bold;"><?php echo e($user->name); ?></span>
    <?php else: ?>
...
<?php echo $__env->make('layouts.user_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/member_dashboard/dashboard.blade.php ENDPATH**/ ?>