        ...
        <div class="container">
            ...
            <aside class="col-lg-5">
                <div class="rounded-4 mb-3 d-flex justify-content-center">
                    <a class="rounded-4 glightbox" data-type="image" href="<?php echo e($image); ?>">
                        <img id="product-image" style="max-width: 100%; max-height: 100vh; margin: auto;" class="rounded-4 fit" src="<?php echo e($image); ?>" />
                    </a>
                </div>
                ...
                <main class="col-lg-7">
                    <div class="ps-lg-3">
                        ...
                        <div class="product-price mb-3 mt-3">
                            <span class="h4" style="color:#f55b29;">Rs. <?php echo e($price); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chint\OneDrive\Documents\GitHub\online-marketing\resources\views/single_product_page.blade.php ENDPATH**/ ?>