...
<nav id="sidebarMenu" class="collapse navbar-collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
        <div class="list-group list-group-flush mx-2 mt-4">
            <a href="<?php echo e(route('index')); ?>" class="list-group-item list-group-item-action py-3" data-mdb-ripple-init aria-current="true">
                <span>Home</span>
            </a>
            <a href="<?php echo e(route('ad_center')); ?>" class="list-group-item list-group-item-action py-3 " data-mdb-ripple-init>
                <span>Ad Center</span>
            </a>
...
<?php /**PATH C:\Users\chint\OneDrive\Documents\GitHub\online-marketing\resources\views/layouts/affiliate_main/sidebar.blade.php ENDPATH**/ ?>