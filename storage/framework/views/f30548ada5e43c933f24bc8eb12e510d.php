                        ...
                        <div class="sale-item position-relative">
                            <a href="<?php echo e(route('single_product_page', ['product_id' => $sale->product->product_id])); ?>" class="d-block text-decoration-none">
                                <div class="sale-image-wrapper position-relative">
                                    ...
                                    <button type="button" class="btn btn-cart position-absolute bottom-0 end-0 me-2 mb-2" data-bs-toggle="modal" data-bs-target="#cartModal_<?php echo e($sale->product->product_id); ?>">
                                        <i class="bi bi-cart-plus"></i>
                                    </button>
                                </div>
                                <h6 class="product-name"><?php echo e(\Illuminate\Support\Str::limit($sale->product->product_name, 25, '...')); ?></h6>
                                <div class="price">
    ...
    <ul class="pagination justify-content-end mb-4" id="pagination">
        <?php if($sales->currentPage() > 1): ?>
            <li class="page-item" id="prevPage">
                <a class="page-link" href="#" aria-label="Previous" data-page="<?php echo e($sales->currentPage() - 1); ?>">
...
<!-- cart modal -->
<?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal fade" id="cartModal_<?php echo e($sale->product->product_id); ?>" tabindex="-1" aria-labelledby="cartModalLabel" aria-hidden="true">
                    ...
                    <div class="row gx-5">
                        <aside class="col-lg-5">
                            <div class="rounded-4 mb-3 d-flex justify-content-center">
                                <a class="rounded-4 main-image-link" href="<?php echo e(asset('storage/' . $sale->product->images->first()->image_path)); ?>">
                                    <img id="mainImage" class="rounded-4 fit" src="<?php echo e(asset('storage/' . $sale->product->images->first()->image_path)); ?>" />
                                </a>
                            </div>
                        ...
                        <main class="col-lg-7">
                            ...
                            <?php else: ?>
                                <a href="#" class="btn btn-custom-cart mb-3 add-to-cart-modal shadow-0 <?php echo e($sale->product->quantity <= 1 ? 'btn-disabled' : ''); ?>" 
                                    data-product-id="<?php echo e($sale->product->product_id); ?>" data-auth="false" style="width: 40%;">
                                    <i class="me-1 fa fa-shopping-basket"></i>Add to cart
                                </a>
                            <?php endif; ?>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chint\OneDrive\Documents\GitHub\online-marketing\resources\views/flash_sale.blade.php ENDPATH**/ ?>