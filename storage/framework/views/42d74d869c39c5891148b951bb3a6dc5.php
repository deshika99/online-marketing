                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="woocommerce-widget-area">
                            <div class="woocommerce-widget filter-list-widget">
                                    ...
                                    <a href="<?php echo e(route('special-offers')); ?>" class="delete-selected-filters"><i class='bx bx-trash'></i> <span>Clear All</span></a>
                            ...
                            <div class="woocommerce-widget collections-list-widget">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(route('special-offers')); ?>?category=<?php echo e($category->parent_category); ?>" 
                            ...
                            <div class="woocommerce-widget size-list-widget">
                                ...
                                <ul class="size-list-row">
                                    <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="<?php echo e(route('special-offers')); ?>?size=<?php echo e($size->value); ?>" 
                            ...
                            <div class="woocommerce-widget color-list-widget">
                                ...
                                <ul class="color-list-row">
                                    <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="<?php echo e(route('special-offers')); ?>?color=<?php echo e($color->value); ?>" 
                                            ...
                                            <div class="single-products-box">
                                                ...
                                                <a href="<?php echo e(route('product-description', ['product_id' => $product->product_id])); ?>">
                                                    <?php if($product->images->isNotEmpty()): ?>
                                                        <img src="<?php echo e(asset('storage/' . $product->images->first()->image_path)); ?>" class="main-image" alt="image" style="width: 60%; height:270px">
                                                        <img src="<?php echo e(asset('storage/' . $product->images->first()->image_path)); ?>" class="hover-image" alt="image"  style="width: 60%; height:270px">
                                                    <?php else: ?>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\online-marketing\resources\views/frontend/special-offers.blade.php ENDPATH**/ ?>