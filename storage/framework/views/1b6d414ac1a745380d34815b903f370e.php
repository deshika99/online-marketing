                        ...
                        <table id="example" class="table" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo e($user->image_path ? asset('storage/user_images/' . $user->image_path) : asset('assets/images/default-user.png')); ?>" width="40" alt="User Image">
                                    </td>
                                    ...
                                    <td class="action-buttons">
                                        <button class="btn btn-info btn-sm view-btn" data-bs-toggle="modal" data-bs-target="#UserdetailsModal" data-id="<?php echo e($user->id); ?>" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="btn btn-warning btn-sm"  style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form id="delete-form-<?php echo e($user->id); ?>" action="<?php echo e(route('delete_user', $user->id)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" class="btn btn-danger btn-sm" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;" onclick="confirmDelete('delete-form-<?php echo e($user->id); ?>', 'Are you sure you want to delete this user?')">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form id="addUserForm" action="<?php echo e(route('admin_users.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="form-check form-switch ms-3">
                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="status" <?php echo e(old('status', 'on') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin_main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/admin_dashboard/users.blade.php ENDPATH**/ ?>