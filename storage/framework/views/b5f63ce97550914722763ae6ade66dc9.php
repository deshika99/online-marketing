                    ...
                    <div class="offer-item position-relative">
                        <a href="<?php echo e(route('single_product_page', ['product_id' => $product->product_id])); ?>" class="d-block text-decoration-none">
                                ...
                                <div class="offer-image-wrapper position-relative">
                                    ...
                                    <?php if($product->specialOffer && $product->specialOffer->status === 'active'): ?>
                                        <div class="rate-badge position-absolute top-0 end-0 m-0" style="background-color: #FFD43B; color: black; padding: 5px; border-radius: 5px; font-weight: bold;">
                                            <?php echo e(floor($product->specialOffer->offer_rate)); ?>%
                                        </div>
                                    <?php elseif($product->sale && $product->sale->status === 'active'): ?>
                                        <div class="rate-badge position-absolute top-0 end-0 m-0" style="background-color: #FFD43B; color: black; padding: 5px; border-radius: 5px; font-weight: bold;">
                                            <?php echo e(floor($product->sale->sale_rate)); ?>%
                                        </div>
                                    <?php endif; ?>
                            ...
                            <div class="price">
                                ...
                                <?php elseif($product->sale && $product->sale->status === 'active'): ?>
                                    <span class="offer-price">Rs. <?php echo e(number_format($product->sale->sale_price, 2)); ?></span>
                                    <s style="font-size: 14px; color: #989595; font-weight:500">Rs. <?php echo e(number_format($product->normal_price, 2)); ?></s>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\chint\OneDrive\Documents\GitHub\online-marketing\resources\views/best_sellers.blade.php ENDPATH**/ ?>