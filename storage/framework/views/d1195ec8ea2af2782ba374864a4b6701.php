            ...
            <div class="order-item" style="display: flex; align-items: center; padding: 10px; border-bottom: 1px solid #eaeaea;">
                <div style="margin-right: 15px;">
                    <?php if($item->product->images->isNotEmpty()): ?>
                        <a href="<?php echo e(route('single_product_page', ['product_id' =>  $item->product->product_id])); ?>"><img src="<?php echo e(asset('storage/' . $item->product->images->first()->image_path)); ?>" alt="Product Image" width="70" height="auto"></a>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.user_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\online-marketing\resources\views/member_dashboard/order-details.blade.php ENDPATH**/ ?>