            ...
            <div class="card" style="width: 40%;">
                ...
                <div class="card-body p-2">
                    ...
                    <div class="text-start ps-3 mt-4">
                        ...
                        <p class="mb-1"><i class="fa-solid fa-address-book me-3"></i><?php echo e($customer->address); ?>, <?php echo e($customer->district); ?></p>
                    </div>
                </div>
            </div>

            <div class="d-flex flex-wrap" style="width: 55%; height: auto;">
                <div class="card me-2 mb-2" style="flex: 1 1 45%; height: 45%; border: 1px dotted #007bff; background-color: #f0f8ff;">
                ...
                <div class="card me-2 mb-2" style="flex: 1 1 44%; height: 45%; border: 1px dotted #28a745; background-color: #eafaf1;">
                    <div class="card-body text-center">
                ...
                <div class="card me-2 mb-2" style="flex: 1 1 45%; height: 45%; border: 1px dotted #ffc107; background-color: #fff8e1;">
                    <div class="card-body text-center">
                ...
                <div class="card me-2 mb-2" style="flex: 1 1 44%; height: 45%; border: 1px dotted #dc3545; background-color: #ffeef0;">
                    <div class="card-body text-center">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="status <?php echo e(strtolower(str_replace(' ', '-', $order->status))); ?> fw-bold">
...
<?php echo $__env->make('layouts.admin_main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/admin_dashboard/customer-details.blade.php ENDPATH**/ ?>