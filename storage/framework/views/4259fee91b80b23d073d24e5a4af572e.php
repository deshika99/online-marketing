                    ...
                    <a class="nav-link dropdown-toggle hidden-arrow d-flex align-items-center" href="#"
                        ...
                        <div class="icon-circle">
                          <?php if(session('image_path')): ?>
                              <img src="<?php echo e(asset(session('image_path'))); ?>" alt="Admin Image" class="rounded-circle" height="35" width="35">
                          <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/layouts/admin_main/navbar.blade.php ENDPATH**/ ?>