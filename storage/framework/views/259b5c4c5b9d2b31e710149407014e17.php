        ...
        <div class="col-md-10 mt-5">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <?php if(Route::has('register')): ?>
                    <a class="btn btn-link-reg" href="<?php echo e(route('register')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\esupport_systems\online-marketing\resources\views/auth/login.blade.php ENDPATH**/ ?>